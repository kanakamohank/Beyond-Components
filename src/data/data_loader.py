...
# Re-export arithmetic loader so train.py can find it via
# getattr(data_loader, "load_arithmetic_dataset")
from .arithmetic_dataset import load_arithmetic_dataset  # noqa: F401
...
def _get_data_main_dir():
    """Get the path to the data_main directory at the project root."""
    # src/data/data_loader.py -> src/data/ -> src/ -> project_root
    project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    return os.path.join(project_root, 'data_main')
