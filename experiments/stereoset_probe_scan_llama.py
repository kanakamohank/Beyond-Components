"""Stage 2 (Llama-3.2 variant): scan Llama-3.2-3B's top-4 OV-SVD
planes against every Llama-tokenized StereoSet probe pair.

Output:
  helix_usage_validated/stereoset_scan_llama.jsonl
  helix_usage_validated/stereoset_scan_llama_summary.txt
"""
...
PAIRS_PATH = OUT_DIR / "stereoset_probe_pairs_llama.tsv"
...
# Llama-3 vocab is 128k; scale DECODE_TOPK proportionally.
DECODE_TOPK = 1000
...
def main():
    ...
    jsonl_path = OUT_DIR / "stereoset_scan_llama.jsonl"
    ...
    sum_path = OUT_DIR / "stereoset_scan_llama_summary.txt"
