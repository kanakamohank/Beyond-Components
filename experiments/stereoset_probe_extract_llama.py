"""Stage 1 (Llama-3.2 variant): extract StereoSet probe pairs using
Llama-3.2-3B tokenizer.

Outputs:
  helix_usage_validated/stereoset_probe_pairs_llama.tsv
  helix_usage_validated/stereoset_probe_halfmatch_llama.tsv
"""
...
def main():
    ...
    print()
    print("=== per-domain summary (Llama tokenizer) ===")
    for d in DOMAINS:
    ...
    pair_path = OUT_DIR / "stereoset_probe_pairs_llama.tsv"
    ...
    half_path = OUT_DIR / "stereoset_probe_halfmatch_llama.tsv"
