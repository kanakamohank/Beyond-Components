...
|---|---|
| `layer_scan_curves.png` | `experiments/arithmetic_circuit_scan_updated.py` → `experiments/make_paper_figures.py` |
| `ablation_curves.png` | `experiments/fourier_knockout.py`, `experiments/multilayer_freq_ablation.py` |
| `neuron_frequency_tuning.png` | `experiments/neuron_trig_analysis.py` |
| `fourier_heatmap_cross_model.png` | `experiments/fourier_decomposition.py` (layer sweep) |
| `eigenvector_fourier_cross_model.png` | `experiments/eigenvector_dft.py` → `experiments/plot_eigenvector_dft.py` |
| `energy_explosion.png` | `experiments/fourier_decomposition.py` |
